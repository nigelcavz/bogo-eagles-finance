                    ...
                    <form method="POST" action="{{ route('contribution-categories.store') }}" class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                min="0"
                                max="12"
                                value="{{ old('january_full_payment_discount_months', 2) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                                required
                            >
                            <p class="mt-1 text-xs text-gray-500">
                                Used for Monthly Dues when all 12 months are paid in January. Example: `2` means charge 10 months and mark the final 2 months as discounted.
                            </p>
                        </div>
